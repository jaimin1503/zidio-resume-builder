    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-1">
          {/* Sidebar */}
          <div className="bg-gray-100 p-8 w-1/3 flex flex-col">
            <div className="mb-8">
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-blue-600 mb-4">LANGUAGES</h2>
              <p className="mb-0">English</p>
              <p className="mb-0">German</p>
              <p className="mb-0">Spanish</p>
            </div>
            <div>
              <h2 className="text-xl font-semibold text-blue-600 mb-4">HOBBIES</h2>
